...
export interface ApiCarepathCarepath extends Struct.CollectionTypeSchema {
  collectionName: 'carepaths';
  info: {
    displayName: 'Carepath';
    pluralName: 'carepaths';
    singularName: 'carepath';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Illness: Schema.Attribute.Component<'umcu.component-illness', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::carepath.carepath'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Title: Schema.Attribute.String;
...
export interface ApiIllnessIllness extends Struct.CollectionTypeSchema {
  collectionName: 'illnesses';
  info: {
    displayName: 'Illness';
    pluralName: 'illnesses';
    singularName: 'illness';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiParagraphParagraph extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    DynamicContent: Schema.Attribute.DynamicZone<
      ['shared.rich-text', 'shared.media', 'umcu.component-form']
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::carepath.carepath': ApiCarepathCarepath;
      'api::category.category': ApiCategoryCategory;
      'api::chapter.chapter': ApiChapterChapter;
      'api::global.global': ApiGlobalGlobal;
      'api::illness.illness': ApiIllnessIllness;
